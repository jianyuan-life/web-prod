...
const PLAN_SPECIFIC_NOTICE: Record<PlanCode, { title: string; items: string[]; timing?: string }> = {
  E1: {
    title: '事件擇吉須知',
    items: [
      '針對「單一重要事件」精算 1-3 個最佳吉時方案（寧缺勿濫、嚴選不湊數）',
      '🔴 32 凶硬剔除（五黃 / 太歲 / 三煞 / 死門 / 凶格 9 種 / 截路空亡等、凶時絕不放行）',
      '✨ 25 吉法則加權（真詐 / 玉女守門 / 青龍返首 / 十遁 / 三奇得使等）',
      '🌐 真太陽時經度校準（港台客戶實測差 ±23 分鐘）',
  ...
  E3: {
    title: '💎 月度精選須知（寧缺勿濫頂規篩選）',
    items: [
      '為您選定的 1-3 個主題用神（事業／財運／感情／健康／學業／貴人／化解小人／家庭）尋找最多 8 個高純度吉時',
      '🔴 32 凶硬剔除：五黃 / 太歲 / 三煞 / 歲破 / 二黑 / 月家五黃 / 月破 / 戊己都天 / 死門 / 驚門 / 凶格 9 種 / 截路空亡 等、凶時絕不放行',
      '✨ 25 吉法則加權：真詐 / 玉女守門 / 青龍返首 / 飛鳥跌穴 / 十遁 / 三奇得使 / 主題用神 60% 權重',
      '🌐 真太陽時經度校準（港台 / 大陸客戶經度差實證生效）',
      '⚠️ 真吉稀缺聲明：若指定月份內不足 8 個合格吉時、系統自動跨月延伸搜尋至補足。絕不以低品質時窗湊數',
      '🔁 找到為止、不退差價（您買的是稀缺品質、不是固定數量）',
      '個人年命宮交叉驗證',
      '行事曆邀約自動匯入',
    ],
    timing: '購買後約 10-20 分鐘即可查看；若需跨月延伸、UI 會誠實標示「本月 X 個 + 下月 Y 個 = 共 8 個」',
  },
  E4: {
    title: '年度全運須知',
    items: [
