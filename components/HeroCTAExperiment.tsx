    ...
    >
      {({ variant, track }) => (
        <a
          ...
          className="inline-flex items-center gap-2 px-9 py-4 bg-gold text-dark font-bold rounded-[10px] text-[16px] btn-glow shadow-[0_8px_28px_-10px_rgba(201,168,76,0.55)] hover:scale-[1.02] transition-transform"
