...
const PLANS = {
  ...
  chumenji: [
    { code: 'E1', name: '事件擇吉', price: 59, popular: true,
      ...
      features: ['描述事件背景＋期望結果（200 字）', '14 類事件精準匹配＋自由描述 AI 分類', '32 凶硬剔（五黃 / 太歲 / 三煞 / 死門 / 凶格 9 種 / 截路空亡等）', '25 吉加權（真詐 / 玉女守門 / 青龍返首 / 十遁等）', '真太陽時經度校準（港台客戶實測差 ±23 分）', '個人年命宮交叉驗證', '1-3 個最佳吉時 + 方位度數 + 信心等級', '行事曆邀約一鍵加入'],
      hasQuestion: true,
    },
