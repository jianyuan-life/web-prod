      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto mt-16">
          ...
          {[
            ...
            { q: '出門訣適合什麼場合？', a: '系統支援 15 種事件分類：求財、事業、感情、健康、學業、出行、搬家、投資、官司、婚姻、求醫、談判、考試、簽約等。事件出門訣（$89）針對單一重要事件，精算 Top3 最佳時機；月盤出門訣（$99）按週拆解 4 盤，每盤精選 Top1 吉時，適合持續補運。古籍說「三奇得使，萬事皆宜」，長期使用效果最明顯。' },
