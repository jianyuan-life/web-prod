  ...
  if (event.type === 'checkout.session.completed') {
    ...
    if (birthData && reportId) {
      try {
        ...
        const PLAN_NAMES: Record<string, string> = { C: '人生藍圖', D: '心之所惑', G15: '家族藍圖', R: '合否？', E1: '事件出門訣', E2: '月度出門訣', E3: '週度補運', E4: '年度方案' }
          ...
          if (pts) {
            ...
            if (!updateErr) {
              await supabase.from('point_transactions').insert({
                ...
                description: `${({ C: '人生藍圖', D: '心之所惑', G15: '家族藍圖', R: '合否？', E1: '事件出門訣', E2: '月度出門訣', E3: '週度補運', E4: '年度方案' } as Record<string,string>)[planCode] || planCode} 訂單折抵`,
