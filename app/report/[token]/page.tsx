            ...
            return (
              <>
                ...
                {(() => {
                  ...
                  // ===== G15 家族藍圖專屬(8 條、必須在 C personal 之前!共識避免 cross-plan 污染)=====
                  ...
                  else if (/家族流年|2026|2027|2028|2029|2030|衝刺年|黃金年|調整年|回歸年|家族.*年度|家族.*運勢/.test(t)) hint = '本章節標示家族「年度能量起伏」— 黃金年放手做大事、調整年穩住節奏、衝突高峰月提前準備暫停機制'
                  else if (/家族.*總覽|家族.*關鍵詞|家族.*決策|家族.*挑戰|家族.*策略/.test(t)) hint = '本章節是「家族未來 5 年的策略地圖」— 標出最佳決策時機 + 風險點、提前 1-2 年準備'
