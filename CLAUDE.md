...
**網站版本:** **v5.10.389**(2026-05-16 提示詞合集 30 Prompt 自治產出全 staged:P1 Prompt Caching 完整[FF_AI_PROMPT_CACHE default false、flag off 與改造前完全等價]+ P2-P30 全 additive/flag-off/新檔[tone-charter / crisis-detector / CrisisCard / ifs_translator / geo-pricing / judge / stripe-tax / UpsellModal / charts / transparency / kpi / stream-route / 各部門 script]。type-check EXIT=0、6 repo 本地 commit、push 等老闆[lesson #147]。詳:`Claude-鑑源/tasks/prompt_collection_progress_2026-05-16.md`。歷史 v5.10.384 線下接續:Phase 6 #1 regression admin endpoint dryRun mode wire — generate-report + recalculate-report 加 dryRun 旁路[不寫 DB/不改 status/不發 email/不生 PDF、回生成內容供 similarity diff]+ phase6_regression_100_customers.py regenerate_report() 實作 + 成本守門。4 LLM 95 gate PASS。canonical 對齊 `package.json:version`。歷史 v5.10.350:出門訣 v5.10.348 sprint + .349 CSRF hotfix + .350 UI 對齊、4 LLM 平均 99.5(L1=98/L2=100/L3=100/L4=100)、32 凶 hard filter + 25 吉 boost + 真太陽時校正、4 客戶 × 12 月跨年 48/48 PASS、三 repo push web-prod 45808494 / fortune-research c92ec75 / Fly.io v111。詳:`Claude-鑑源/tasks/qimen_jixiong_overhaul_plan_2026-05-14.md` + lesson #142 不分批 / #143 不猜生辰)
