...
**網站版本：** v5.7.11（2026-04-28 round 6 真審 P0/P1 全修:① generate-report parser 加 TOP1+TOP3+TOP5 三家兼容(QA P0 修 prompt 改 marker 但漏改 parser、TOP1 markers 會 leak 給客戶)② generate-report inline planNames 改 import + 缺 E3/E4 補 ③ E1 fallback prompt TOP5_JSON → TOP3_JSON 對齊主流程 plan-prompts.ts ④ report opengraph isChumenji 改 isChumenjiPlan ⑤ report/[token]/page.tsx 4 處 ['E1','E2'] → isChumenjiPlan(E3/E4 客戶進度頁文案修對) ⑥ dashboard inline PLAN_NAMES + CHUMENJI_CODES 改 import lib/plan-names ⑦ share-card 改 import lib/og-font + lib/plan-names(集中 DRY) ⑧ checkout L371/L387 + webhook L252 inline dict 全改 import;production code 已 0 inline PLAN_NAMES dict 殘留)v5.7.10（2026-04-28 round 5 真審 P0/P1 全修:① 抽 lib/plan-names.ts 集中管理 + 20 處 PLAN_NAMES dict 重構成 import(13 jamie page + 4 cron/accounting + 2 report + 1 generate-pdf)② 抽 lib/og-font.ts 中文字體 helper + 4 個 OG image(pricing/faq/app root/report token)加 NotoTC font fetch ③ generate-report E2 fallback prompt TOP5_JSON → TOP1_JSON 對齊 v2.0 ④ steps E2 字數閘門 400 → 1500 對齊 prompt 期望 ⑤ report opengraph PLAN_DESCRIPTIONS 補 E3/E4;type-check 0 error)v5.7.9（2026-04-28 round 4 真審 P0 全修:首頁 $39 殘留 → $29 / 後台 3 處「月盤出門訣」→「月度單盤」/ pricing OG 4 → 8 方案 grid / generate-report E2 legacy prompt 對齊 v2.0 單月 1 盤;P1 全修:steps L3715 註解「全額退款」→「補開新單(不支援退款)」、PLAN_NAMES_PTS 補 E3/E4、ctaRefund → ctaSupport;P2 收尾:faq OG「付款 & 退費」→「付款 & 服務保證」+ checkout 註解 + index.ts E2 4 週 stale 註解；type-check 0 error)v5.7.8（2026-04-28 退費邏輯全清 + 8 方案命名統一 + 4 LLM 真實審查 ≥95 標準 — TrustBar/terms/faq/footer/PurchaseNoticeModal「不支援退款 + 4 大保證」、刪 /refund 頁;命名 E1=事件擇吉/E2=月度單盤/E3=月度精選/E4=年度全運 全站 sed sweep + JSX text 補修(IA Agent 抓 11 處)、checkout/route.ts L22-25 註解原名復原、SubscribeCTA $89→$59/$99→$29 + E2 月家奇門古法 v2 描述、blog.ts 對比表、i18n.ts/i18n-en.ts「6 種方案 → 8 種方案 + $39 起 → $29 起」;AggregateOffer lowPrice 29/highPrice 279/offerCount 8;workflows/steps.ts 移除 refundUrl 改 mailto + 「客服協助補開新單」)
...
| G15 | 家族藍圖 | $59 | 🟡 待驗證 |
| R | 合否？ | $59 | 🔴 AI 報告待開發 |
| E1 | 事件出門訣 | $59 | ✅ 已上線（14 類事件精準匹配 + Top3 吉時 + 25 層古法評分）|
| E2 | 月度出門訣 | $29 | 🔴 引擎驗證中（月家奇門古法**單月 1 盤、農曆晦日 22:20 執行**、規格 v2.0）|
| E3 | 週度補運 | $89 | ✅ v5.3.78 已上線（1-3 主題用神、4 週 × 每週 Top2 = 8 吉時、占事派 60%）|
| E4 | 年度方案 | $279 | 🔴 立春前限時（年盤 + 12 月盤、每年立春前 30 天開放）|
