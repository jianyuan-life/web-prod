...
⚠️ **大運硬規格(v5.7.30 強要求、違反即重寫)**:必須列**完整 8 個大運**(從起運歲開始、每柱 10 年、共 80 年人生跨度)。常見起運範例:0/10/20/30/40/50/60/70 歲(8 柱、止 79-80 歲)。**不可只寫 5 個或 6 個就停**——客戶 30-40 歲 ≠ 整個人生只到 50 歲、需要看到 70-80 歲的展望。漏寫任 1 柱 = quality gate fail。
