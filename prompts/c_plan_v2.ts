...
用表格呈現 7 個人生面向 × 15 個系統的交叉驗證結果。每格用 ★ 評級(★=弱訊號 / ★★=中等 / ★★★=強訊號 / ★★★★=非常強 / ★★★★★=極強共識)。
...
每行最後一欄填「共識度 %」(指有多少系統指向同一結論、85%+ 表示強共識)。

接著用 200 字解讀矩陣:**這個命格最強的共識是什麼?最分歧的面向是什麼?**
...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 運勢 | 中 | ↑高 | 中 | ↓低 | 中 | ↑高 | ↑高 | 中 | ↑高 | 中 | ↓低 | 中 |

(依八字流月 + 紫微大限 + 奇門月盤交叉、依實際命盤填寫高/中/低)

### 每月運勢表

| 月份 | 整體 | 財運 | 事業 | 感情 | 健康 | 重點主題 |
|:---:|:---:|:---:|:---:|:---:|:---:|:---|
| 2026-01 | ★★★ | ★★ | ★★★ | ★★ | ★★ | ... |
| 2026-02 | ... | ... | ... | ... | ... | ... |
| ...(12 行) | | | | | | |
...
- **最佳月份**:{月份}—— 為什麼好、適合做什麼
- **最需謹慎月份**:{月份}—— 為什麼難、要避開什麼
- **轉折月份**:{月份}—— 大運/流年交接、需要特別注意
